...
import { Plus, Trash2, Edit2, TrendingUp, TrendingDown, DollarSign, Loader2 } from "lucide-react";
import { trpc } from "@/lib/trpc";
import { toast } from "sonner";

export default function FinancialConnected() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur">
          ...
          <CardContent>
            <p className={`text-3xl font-bold ${(summary?.balance || 0) >= 0 ? "text-green-400" : "text-red-400"}`}>
        ...
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur">
          ...
          <CardContent>
            <p className="text-3xl font-bold text-green-400">R$ {(summary?.totalIncome || 0).toFixed(2)}</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur">
          ...
          <CardContent>
            <p className="text-3xl font-bold text-red-400">R$ {(summary?.totalExpense || 0).toFixed(2)}</p>
          </CardContent>
        </Card>
      </div>
